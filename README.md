...
```text
stacs-temporal-graph-verification/
├── data/                          # JSONL datasets (canonical, TempEval-3, diagnostic)
...
│   ├── import_test_of_time.py     # Convert Test of Time benchmark → canonical JSONL
...
- TempEval-3 adapter, Test of Time benchmark adapter, and diagnostic evaluation slice
- RQ3 verifier-to-correctness Spearman correlation module (`src/analysis/correctness_correlation.py`)
- ten supplementary dissertation plots generated by `scripts/generate_analysis_plots.py`
